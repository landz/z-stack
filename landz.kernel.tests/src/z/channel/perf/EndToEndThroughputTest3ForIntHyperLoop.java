 ...
 */
public class EndToEndThroughputTest3ForIntHyperLoop {

  private static final int RUNS = 500_000_000;//100_000_000;

  private IntHyperLoop loop = new IntHyperLoop();
  private IntHyperLoop.OutPort out = loop.createOutPort();

  @Test
  public void testHyperLoop() {
    System.out.println("test another OUT recieve API for IntHyperLoop");
      runHyperLoop();
  }
...
//    Affinity.bindTo(Topology.socket(0).physicalCore(2).virtualCore(0));
    ...
    new EndToEndThroughputTest3ForIntHyperLoop().testHyperLoop();
  }
