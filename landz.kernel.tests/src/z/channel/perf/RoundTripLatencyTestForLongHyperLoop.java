...
public class RoundTripLatencyTestForLongHyperLoop {
  private static class MyRunnable implements Runnable
  {
    private LongHyperLoop.OutPort outC;
    private LongHyperLoop loopP;

    public MyRunnable(LongHyperLoop.OutPort outC, LongHyperLoop loopP)
    {
      this.outC = outC;
      this.loopP = loopP;
    }
...
//      Affinity.bindTo(Topology.socket(0).physicalCore(3).virtualCore(0));
  ...
  private LongHyperLoop loopC = new LongHyperLoop(1024);
  private LongHyperLoop.OutPort outC = loopC.createOutPort();

  private LongHyperLoop loopP = new LongHyperLoop(1024);
  private LongHyperLoop.OutPort outP = loopP.createOutPort();
...
//    }
    ...
    new RoundTripLatencyTestForLongHyperLoop().testHyperLoop();
  }
