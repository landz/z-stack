...
/**
 *  {@link ContendedHyperLoop} is an Inter-Thread-Communication(ITC) mechanism.
 *  <P>
 *  Note:<p>
 ...
 *
 */
public class ContendedHyperLoop {
...
//  private final long addrWriteCursor;
   ...
   */
  public ContendedHyperLoop(int nBufferSlots) {
    ...
    this.addrBuffer = addressHyperLoop + SIZE_CACHE_LINE_PADDING;
   ...
   * TODO: overload buffer based version??
   * @param value
   * @return
   */
...
//        value);
  ...
  public final class Out {
    ...
    public void receive() {
      long readCursor = UNSAFE.getLongVolatile(null,addrReadCursor);
